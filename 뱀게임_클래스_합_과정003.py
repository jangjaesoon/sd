...
while True :
    ...
    for i in range(뉴런.입력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (1,0,255),(700,200+i*30),13,10)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (1,0,255),(800,200+i*30),13,10)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (1,0,255),(900,200+i*30),13,10)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (1,0,255),(1000,200+i*30),13,10)
    for i in range(뉴런.출력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (1,0,255),(1100,200+i*30),13,10)


    뱀게임.게임.draw.circle(뱀게임.화면, (입력[0]/3,0,0),(700,200),10)
    뱀게임.게임.draw.circle(뱀게임.화면, (입력[1]/3,0,0),(700,200+30),10)

    뱀게임.게임.draw.circle(뱀게임.화면, (입력[2]/3,0,0),(700,200+60),10)
    뱀게임.게임.draw.circle(뱀게임.화면, (입력[3]/3,0,0),(700,200+90),10)

    뱀게임.게임.draw.circle(뱀게임.화면, ((입력[4]+1)*100,0,0),(700,200+120),10)
    뱀게임.게임.draw.circle(뱀게임.화면, ((입력[5]+1)*100,0,0),(700,200+150),10)
